            ...
            if (isset($_REQUEST['submit'])) {
                ...
                if (mysqli_num_rows($query) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($query)) {
                        ...
                        if (!empty($row['file'])) {
                            <?= ' <strong><a href="?page=dlc&act=fcl&id_cek=' . $row['id_cek'] . '">' . $row['file'] . '</a></strong>' ?>;
                        } else {
                            <?= ' <em>Tidak ada file yang diupload</em>' ?>;
                        }
                        <?= '</td>
                        ...
                        if ($_SESSION['id_user'] != $row['id_user'] and $_SESSION['id_user'] != 1 and $_SESSION['id_user'] != 2) {
                            ...
                            <?= '<a class="btn small blue waves-effect waves-light" href="?page=ilc&act=edit&id_cek=' . $row['id_cek'] . '">
