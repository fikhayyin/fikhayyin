                ...
                while ($row = mysqli_fetch_array($query)) {
                    ...
                    echo '
                                ...
                                <div class="card-action">
            		                <a href="?page=kel&sub=usr&act=del&submit=yes&id_user=' . $row['id_user'] . '" class="btn-large deep-orange waves-effect waves-light white-text">HAPUS <i class="material-icons">delete</i></a>
            		                <a href="?page=kel&sub=usr" class="btn-large blue waves-effect waves-light white-text">BATAL <i class="material-icons">clear</i></a>
            		            </div>
                            </div>
                        </div>
                    </div>
                    ...
                    if (isset($_REQUEST['submit'])) {
                        ...
                        $query = mysqli_query($config, "DELETE FROM user WHERE id_user='$id_user'");
                        ...
                        if ($query == true) {
                            ...
                            echo '<script language="javascript">
                                    window.location.href="./admin.php?page=kel&sub=usr&act=del&id_user=' . $id_user . '";
                                  </script>';
                        }
                    }
                }
