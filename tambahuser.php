...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if ($_REQUEST['username'] == "" || $_REQUEST['password'] == "" || $_REQUEST['nama'] == "" || $_REQUEST['nip'] == "" || $_REQUEST['admin'] == "") {
            ...
            header("Location: ./admin.php?page=kel&sub=usr&act=add");
            die();
        } else {
                            ...
                            if ($result > 0) {
                                ...
                                if (strlen($username) < 5) {
                                    ...
                                    if (strlen($password) < 5) {
                                        ...
                                        if ($query != false) {
                                            $_SESSION['succAdd'] = 'SUKSES! Pengguna baru berhasil ditambahkan';
            ...
            <div class="col s12">
                <nav class="secondary-nav">
                    <div class="nav-wrapper blue-grey darken-1">
                        <ul class="left">
                            <li class="waves-effect waves-light"><a href="?page=kel&sub=usr&act=add" class="judul"><i class="material-icons">person_add</i> Tambah Pengguna</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
        ...
        <div class="row jarak-form">
            ...
            <!-- Form START -->
            <form class="col s12" method="post" action="?page=kel&sub=usr&act=add">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s6">
                        <i class="material-icons prefix md-prefix">supervisor_account</i><label>Pilih Level Pengguna</label><br />
                ...
                <div class="row">
                    ...
                    <div class="col 6">
                        <a href="?page=kel&sub=usr" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                    </div>
                </div>
